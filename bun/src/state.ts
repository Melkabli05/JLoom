...
/** Same JSON shape as the Java version's .jloom/state.json (plain JSON + ISO date strings) -
 * a project generated by either implementation can be read by the other. */
