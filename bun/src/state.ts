...
// Plain JSON + ISO date strings - the same shape the previous Java implementation wrote, so a
// project generated by either implementation can be read by the other.
